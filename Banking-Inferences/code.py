...
def check_true_mean(confidence_interval):
    if (true_mean>confidence_interval[0]) & (true_mean<confidence_interval[1]):
        return "True mean falls in the range"
    else:
        return "True mean does not falls in the range"
result=check_true_mean(confidence_interval)
print(result)
