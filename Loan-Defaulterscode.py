...
plt.bar(fully_paid.index,fully_paid, align='center', alpha=0.5)
...
X_train['int.rate']=X_train['int.rate'].map(lambda x: x/100)
...
# Code starts here
cols=num_df.columns
fig,axes = plt.subplots(9,1,figsize=(15,10))
for i in range(0,9):
...
# Code starts here
mod_2=DecisionTreeClassifier(random_state=0)
p_tree=GridSearchCV(estimator=mod_2,param_grid=parameter_grid,cv=5)
